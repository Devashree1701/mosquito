...
def execute_trapping_state():
    ...
    if minute_counter in [29, 59]: # TODO: replace with desired time to take pics
        take_picture()
...
def execute_marking_state():
    ...
    time.sleep(2)
    GPIO.output(PRESSOR_PIN, 0)
    time.sleep(1) #TODO: change to add duration of air compressor
    GPIO.output(PRESSOR_PIN, 1)
    time.sleep(3)
